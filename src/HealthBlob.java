...
public class HealthBlob extends GameObject {
    ...
    public HealthBlob(float x, float y, float health, ID id, Handler handler) {
        super(x, y, health, id);
    ...
    public void tick() {
        ...
        handler.addObject(new Trail((int)x,(int)y,0,ID.Trail,16,0.02f,16,Color.green, handler));
